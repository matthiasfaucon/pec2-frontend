  ...
  List<Widget> _buildUserDetailsList(Map<dynamic, dynamic> user) {
    ...
    if (user['enable'] != null) {
      ...
      statusWidgets.add(
        Chip(
          backgroundColor:
              enabled ? Colors.green.shade100 : Colors.red.shade100,
          label: Text(
    ...
    if (user['subscriptionEnable'] != null) {
      ...
      statusWidgets.add(
        Chip(
          backgroundColor:
              subEnabled ? Colors.green.shade100 : Colors.orange.shade100,
          label: Text(
            subEnabled ? 'Abonnement actif' : 'Pas d\'abonnement',
            style: TextStyle(
              color:
                  subEnabled ? Colors.green.shade800 : Colors.orange.shade800,
            ),
          ),
        ),
      );
    ...
    if (user['commentsEnable'] != null) {
      ...
      statusWidgets.add(
        Chip(
          backgroundColor:
              commentsEnabled ? Colors.green.shade100 : Colors.grey.shade300,
          label: Text(
            commentsEnabled
    ...
    if (user['messageEnable'] != null) {
      ...
      statusWidgets.add(
        Chip(
          backgroundColor:
              messagesEnabled ? Colors.green.shade100 : Colors.grey.shade300,
          label: Text(
